        ...
        <div class="col-md-3">
          ...
          <div class="box box-primary">
            <div class="box-body box-profile">
              <img class="profile-user-img img-responsive" src="<?php echo $avatar;?>" alt="User profile picture">
        ...
        <div class="col-md-9">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              <li class="<?php echo $pag == 'myactivities' ? 'active' : ''; ?>"><a href="?id=<?php echo $id;?>&perfil=myactivities.php">My Activities</a></li>
              <li class="<?php echo $pag == 'informtcion' ? 'active' : ''; ?>"><a href="?id=<?php echo $id;?>&perfil=informtcion">Information</a></li>
              <li class="<?php echo $pag == 'pictures' ? 'active' : ''; ?>"><a href="?id=<?php echo $id;?>&perfil=pictures">Pictures</a></li>
            </ul>
