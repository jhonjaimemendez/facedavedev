	...
	<div id="navwrapper">
		<form action="/facedavedev/signin.php" method="post">
			...
			<div id="navbar">
				...
				<h1 class="logowrapper">FaceDave</h1>
	...
	<div id="contentwrapper">
		<div id="content">
			...
			<div id="leftbod">
				...
				<div class="connect bolder">Social network created Developed with
					PHP and MongoDB.</div>
				...
				<div class="leftbar">
					...
					<div class="fb1">
						<span class="rowtext">Analyze the advantages and disadvantages </span>
						<span class="rowtext fb1">of using MongoDB vs MySQL as a database
							engine</span>
					</div>
				</div>
			...
			<div id="rightbod">
				...
				<div class="free bolder">We do not sell your data</div>
				<form action="/facedavedev/signup.php" method="post">
					<div class="formbox">
						<input type="text" class="inputbody in2" placeholder="names"
							name="names" required> <input type="text" class="inputbody in2"
							placeholder="Surname" name="surname" required>
					</div>
					<div class="formbox">
						<input type="email" class="inputbody in2" placeholder="Email"
							name="email" required>
					</div>
					<div class="formbox">
						<input type="email" class="inputbody in2"
							placeholder="Re-enter email" required>
					</div>
					<div class="formbox">
						<input type="password" class="inputbody in2"
